...
class Game {
    ...
    calculateAvailableGameActions(board) {
        ...
        // available actions: MOVE, ROLLDIE, NONE, BEAT, LEAVE_HOUSE
        //die value available?
                    ...
                    if(board.getFieldType(tokenField) === 'REGULAR') {
                        ...
                        if (nextPosition === "goalArray") {
                            ...
                            if(this.isGoalPathClear(board,neededFields)) {
                                this.gameActions.push(new GameAction(currentPlayer.playerId,'ENTERGOAL',
                        ...
                        if(this.isGoalPathClear(board,this.currentDieValue)) {
                            ...
                            this.gameActions.push(new GameAction(currentPlayer.playerId, 'MOVEGOAL',
